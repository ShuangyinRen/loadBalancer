...
int main (int argc, char *argv[]) 
{
  ...
  servers = server_number;  // Servidores fijos
      ...
      switch(k)
      {
	    ...
	    {    
	      ...
	      for(int i=0;i < servers;i++) 
	      {
	        ...
	        clients = clients + stepClient; // Aumenta clientes
	    }
	    relation=0;
    }
